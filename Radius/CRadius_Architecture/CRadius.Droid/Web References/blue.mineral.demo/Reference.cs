...
namespace CRadius.Droid.blue.mineral.demo {
    using System;
    ...
    public partial class Radius : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Radius() {
            this.Url = "http://demo.mineral.blue/services/radius.svc";
        ...
        public void DoError([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string username, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string password, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string errorMessage, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string innerException, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string stackTrace, int liveness, [System.Xml.Serialization.XmlIgnoreAttribute()] bool livenessSpecified) {
        ...
        /// <remarks/>
        public void DoErrorAsync(string username, string password, string errorMessage, string innerException, string stackTrace, int liveness, bool livenessSpecified) {
            this.DoErrorAsync(username, password, errorMessage, innerException, stackTrace, liveness, livenessSpecified, null);
        }
        
        /// <remarks/>
        public void DoErrorAsync(string username, string password, string errorMessage, string innerException, string stackTrace, int liveness, bool livenessSpecified, object userState) {
            ...
            this.InvokeAsync("DoError", new object[] {
                        ...
                        stackTrace,
                        liveness,
                        livenessSpecified}, this.DoErrorOperationCompleted, userState);
        }
        ...
        public RadiusPayload Handshake([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string username, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string deviceID) {
            object[] results = this.Invoke("Handshake", new object[] {
                        username,
                        deviceID});
            return ((RadiusPayload)(results[0]));
        }
        
        /// <remarks/>
        public void HandshakeAsync(string username, string deviceID) {
            this.HandshakeAsync(username, deviceID, null);
        }
        
        /// <remarks/>
        public void HandshakeAsync(string username, string deviceID, object userState) {
            ...
            this.InvokeAsync("Handshake", new object[] {
                        username,
                        deviceID}, this.HandshakeOperationCompleted, userState);
        }
    ...
    public partial class RadiusPayload {
        ...
        private bool fatalFieldSpecified;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool FatalSpecified {
            get {
                return this.fatalFieldSpecified;
            }
            set {
                this.fatalFieldSpecified = value;
            }
        }
    ...
    public partial class HandshakeCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public RadiusPayload Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((RadiusPayload)(this.results[0]));
            }
        }
    }
}
